...
class Crud_model extends CI_Model {
    ...
    ///////////pd//////////////
     function get_pdn() {
        $query = $this->db->get('nilai_pd');
        return $query->result_array();
    }
    ////////STUDENT/////////////
    function get_students($class_id) {
        $query = $this->db->get_where('student', array('section_id' => $class_id));
        return $query->result_array();
    }
    ...
    function get_student_info($student_id) {
        ...
        function get_student_name($nis) {
        $query = $this->db->get_where('student', array('nis' => $nis));
    ...
    function get_tema($table,$id,$tema_id) {
        $query = $this->db->get_where($table, array($id => $tema_id));
        $res = $query->result_array();
        foreach ($res as $row)
            return $row['tema'];
    }
    ...
    function get_subject_name($subject_id) {
     ...
     function get_pd_name($subject_id) {
        $query = $this->db->get_where('pd', array('id' => $subject_id));
        $res = $query->result_array();
        foreach ($res as $row)
            return $row['name'];
    }
    ...
    function get_image_url($type = '', $id = '') {
        if (file_exists(base_url().'uploads/' . $type . '_image/' . $id . '.jpg'))
