							...
							<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('section');?></label>
			                    <div class="col-sm-5">
			                        <select name="section_id" class="form-control" id="section_selector_holder">
			                        	 <?php 
									$s = $this->db->get_where('section',array('section_id'=>$row['section_id']))->result_array();
									foreach($s as $row3):
										?>
                                		<option value="<?php echo $row3['section_id'];?>" selected>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="sex" class="form-control">
                              <option value=""><?php echo get_phrase('select');?></option>
                              <option value="Laki-laki" <?php if($row['sex'] == 'Laki-laki')echo 'selected';?>>Laki-laki</option>
                              <option value="Perempuan"<?php if($row['sex'] == 'Perempuan')echo 'selected';?>>Perempuan</option>
                          </select>
						</div> 
					</div>
