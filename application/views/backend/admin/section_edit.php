		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
            		<i class="entypo-plus-circled"></i>Ubah Data Kelas
            	</div>
            </div>
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'admin/sections/edit/' . $row['section_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						<label for="field-2" class="col-sm-3 control-label">Guru</label>
                    ...
                    <div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info">Ubah Kelas</button>
						</div>
					</div>
                <?php echo form_close();?>
            </div>
