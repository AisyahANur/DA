	...
	<div class="col-md-12">
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'teacher/student/'.$row['class_id'].'/do_update/'.$row['student_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<input type="text" name="birthday" value="<?php echo $row['birthday'];?>" placeholder="dd/mm/yyyy" >
						</div> 
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-5">
							<select name="sex" class="form-control">
                              <option value=""><?php echo get_phrase('select');?></option>
                              <option value="male" <?php if($row['sex'] == 'laki-laki')echo 'selected';?>>Laki-laki</option>
                              <option value="female"<?php if($row['sex'] == 'Perempuan')echo 'selected';?>>Perempuan</option>
                          </select>
						</div> 
					</div>
