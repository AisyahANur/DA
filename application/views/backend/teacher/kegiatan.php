        ...
        <div class="tab-content">            
                ...
                <table class="table table-bordered datatable" id="table_export">
                    <thead>
                        <tr>
                            ...
                            <th><div>Kegiatan</div></th>
                            <th><div>Lokasi</div></th>
                            <th><div>Opsi</div></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <tr>
                            ...
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu dropdown-default pull-right" role="menu">
                                    ...
                                    <!-- EDITING LINK -->
                                    <li>
                                        <a href="#" onclick="showAjaxModal('<?php echo base_url();?>modal/popup/modal_edit_kegiatan/<?php echo $row['kegiatan_id'];?>');">
                                    ...
                                    <!-- DELETION LINK -->
                                    <li>
                                        <a href="#" onclick="confirm_modal('<?php echo base_url();?>teacher/kegiatan/delete/<?php echo $row['kegiatan_id'];?>/<?php echo $row['section_id'];?>');">
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url() . 'teacher/kegiatan/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                        <div class="padded">
                        ...
                        <div class="form-group">
                              <div class="col-sm-offset-3 col-sm-5">
                                  <button type="submit" class="btn btn-info">Tambah Kegiatan</button>
                              </div>
                           </div>
                    </form>                
                </div>                
