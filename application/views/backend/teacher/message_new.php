    ...
    <div class="form-group">
        ...
        <select class="form-control select2" name="reciever" required>
            ...
            <optgroup label="<?php echo get_phrase('student'); ?>">
                <?php
                $kelas = $this->db->get_where('section',array('teacher_id',$this->session->userdata('teacher_id')))->result_array();
                $students = $this->db->get_where('student',array('section_id',$kelas['section_id']))->result_array();
            ...
            <optgroup label="Guru">
                ...
                foreach ($parents as $row):
                    ...
                    <option value="parent-<?php echo $row['teacher_id']; ?>">
                        - <?php echo $row['name']; ?></option>
