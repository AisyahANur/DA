<hr />
    ...
    <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered">
        ...
        <tbody>
            <form method="post" action="<?php echo base_url();?>teacher/nilai_selector" class="form">
                <tr class="gradeA">
...
<?php if( $month!='' && $year!='' && $section_id!='' && $subject_id !=0):
?>
                       ...
                       $no = 0;
                        ...
                        <tr class="gradeA">
                            ...
                            <?php 
                                ...
                                $query = $this->db->get_where('nilai' , $verify_data);
                                if($query->num_rows() < 1)
                                $this->db->insert('nilai' , $verify_data);
                                
                                //showing the attendance status editing option
                                $nilai = $this->db->get_where('nilai' , $verify_data)->row();
                          ...
                          <td>
                               ...
                               <?php
                                                ...
                                                if ( $nilai->nilai1 > 0 &&  $nilai->nilai2>0 &&  $nilai->nila3>0 &&  $nilai->nilai4>0){
                                                    $e = 4;
                                                }
                                                else if( $nilai->nilai1 > 0 && $nilai->nilai2>0 &&  $nilai->nilai3>0 && $nilai->nilai4<=0){
                                                     $e = 3;
                                                }
                                                else if( $nilai->nilai1 > 0 &&  $nilai->nilai2>0 &&  $nilai->nilai3<=0 && $nilai->nilai4<=0){
                                                     $e = 2;
                                                 ...
                                                 $sum = ($nilai->nilai1 + $nilai->nilai2 + $nilai->nilai3 + $nilai->nilai4 ) ;
                                                // $sum = $sum / $d;
                                                $avg = $sum / $e;
                                             
                                                // echo $sum <= $kkm->kkm ? '<font color="red">'.$sum.'</font>' : $sum;
                                                // echo $avg;
                                ?>
                          </td> 
                        </tr>
...
<form method="post" 
    action="<?php echo base_url();?>teacher/manage_nilai/<?php echo $month.'/'.$year.'/'.$section_id.'/'.$subject_id;?>">
        <div class="col-sm-offset-3 col-md-6">
            <table  class="table table-bordered">
                <thead>
                    <tr class="gradeA">
                    ...
                    foreach($students as $row)
                    {
                        ...
                        <tr class="gradeA">
                            ...
                            <?php 
                                ...
                                //showing the attendance status editing option
                                $nilai = $this->db->get_where('nilai' , $verify_data)->row();
                                $isi1     = $nilai->nilai1?$nilai->nilai1:'';
                                $isi2     = $nilai->nilai2?$nilai->nilai2:'';
                                $isi3     = $nilai->nilai3?$nilai->nilai3:'';
                                $isi4     = $nilai->nilai4?$nilai->nilai4:'';
                            ...
                            <td align="center">
                                <input type="text" class="form-control" name="nilai4_<?php echo $row['student_id'];?>"
                                value="<?= $isi4;?>"
                                >
                            </td>
